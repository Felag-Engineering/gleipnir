...
- **[Plugin system specification](docs/developer/plugin-system-spec.md)** — design reference for the plugin subsystem (process model, services, trust, credentials, observability).

If you're reporting a bug or requesting a feature, please use the [issue templates](.github/ISSUE_TEMPLATE/).
