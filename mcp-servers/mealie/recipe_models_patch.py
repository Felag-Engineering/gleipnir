...
class Recipe(BaseModel):
    ...
    # Mealie returns these as strings (e.g. "1 hour 30 minutes"), not integers
    totalTime: Optional[Union[int, str]] = None
    prepTime: Optional[Union[int, str]] = None
    cookTime: Optional[Union[int, str]] = None
    performTime: Optional[Union[int, str]] = None
    description: Optional[str] = None
    # Mealie returns these as objects {id, name, slug}, not plain strings
