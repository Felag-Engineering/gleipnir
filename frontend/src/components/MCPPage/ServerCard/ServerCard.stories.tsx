...
const tools: ApiMcpTool[] = [
  { id: 't1', server_id: 'srv1', name: 'kubectl.get_pods', description: 'List pods.', input_schema: {} },
  { id: 't2', server_id: 'srv1', name: 'kubectl.delete_pod', description: 'Delete a pod.', input_schema: {} },
]
