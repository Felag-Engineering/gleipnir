...
function PublicURLSection() {
  const { data: settings, status, refetch } = useAdminSettings()
    ...
    <section className={cardStyles.card}>
      ...
      <div className={cardStyles.cardBody}>
        <QueryBoundary
          ...
          errorMessage="Failed to load settings."
          onRetry={() => { void refetch() }}
          skeleton={<SkeletonList count={2} height={64} gap={12} borderRadius={8} />}
        >
          <div className={cardStyles.fieldGroup}>
...
function SystemInfoSection() {
  const { data: info, status, refetch } = useSystemInfo()
    ...
    <section className={cardStyles.card}>
      ...
      <div className={cardStyles.cardBody}>
        <QueryBoundary
          ...
          onRetry={() => { void refetch() }}
          skeleton={<SkeletonList count={6} height={56} gap={12} borderRadius={8} />}
        >
