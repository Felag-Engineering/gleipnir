...
- `/api/v1/admin/plugin-instances` — read-only listing of installed plugin instances enriched with channel capabilities and declared `event_kinds`. Consumed by the audience editor (#290) and the policy editor's trigger picker (#219). admin|operator|auditor.
