.PHONY: help build test tools security security-go security-frontend proto lint-plugins lint-plugins-self-test lint lint-go-fmt lint-staticcheck ci-local ci-local-full ci-local-lanes ci-local-lint ci-local-drift ci-local-backend ci-local-sdk ci-local-frontend ci-local-scope-self-test relaysmoke lint-relaysmoke-build
...
lint: lint-go-fmt lint-plugins lint-staticcheck lint-substrate-build lint-relaysmoke-build
...
ci-local-lint: lint-go-fmt lint-plugins lint-plugins-self-test ci-local-scope-self-test lint-staticcheck lint-substrate-build lint-relaysmoke-build
