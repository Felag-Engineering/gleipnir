...
lint: lint-go-fmt lint-plugins lint-secret-keys lint-staticcheck lint-substrate-build lint-relaysmoke-build
...
ci-local-lint: lint-go-fmt lint-plugins lint-plugins-self-test lint-secret-keys ci-local-scope-self-test lint-staticcheck lint-substrate-build lint-relaysmoke-build
